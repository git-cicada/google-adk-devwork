...
# Check if pre-existing session exists else create a frest one
...
# Utility function to print habits
# Printing habits - FOR DEBUGGING PURPOSES (can delete if needed)
def print_habits(habits: list[dict]):
    if not habits:
        print("[Habits] (none)")
    else:
        print("[Habits]")
